        ...
        body: BlocBuilder<EditProfileCubit, EditProfileState>(
          builder: (context, state) {
            ...
            if (state is EditProfileLoaded) {
              final sucessState = state;
              return SingleChildScrollView(
                padding: const EdgeInsets.symmetric(horizontal: 16.0),
                child: Column(
                  children: [
                    ProfilePic(
                      image: sucessState.user.photoURL ?? '',
                      imageUploadBtnPress: () {},
                    ),
                    const Divider(),
                    Form(
                      child: Column(
                        children: [
                          UserInfoEditField(
                            text: 'Name',
                            child: TextFormField(
                              initialValue: sucessState.user.displayName ?? '',
                              decoration: const InputDecoration(
                                filled: true,
                                fillColor: Color.fromARGB(255, 155, 248, 158),
                          ...
                          UserInfoEditField(
                            text: "Email",
                            child: TextFormField(
                              initialValue: sucessState.user.email ?? '',
                              decoration: const InputDecoration(
                                filled: true,
                                fillColor: Color.fromARGB(255, 155, 248, 158),
                                contentPadding: EdgeInsets.symmetric(
